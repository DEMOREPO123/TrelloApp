...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-blue-500">finally.</span>
          </h1>
      ...
      {/* CTA Section */}
      <section className="bg-blue-500 py-20  text-center rounded-sm">
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-white py-12 rounded-sm">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-2">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              <Trello className="h-6 w-6 text-blue-200" />
              <span className="text-xl font-bold">Trello</span>
            </div>
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <span>© 2024 Trello. All rights reserved.</span>
              <span>Built with Next.js, Clerk and supabase</span>
            </div>
          </div>
        </div>
      </footer>
