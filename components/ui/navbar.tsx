...
export default function Navbar({
  ...
  // You can use these variables to conditionally render parts of the navbar based on the current route
  // For example, you might want to hide certain buttons on the home page or dashboard page
  //
